...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="desktop.php">Parc-Informatique</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h3  class="btn-get-started scrollto">Ordinateur De Bureau</h3>
          <table class="table table-striped" style="margin-top: 10px; border: 1px solid black; border-radius: 25px!important">
            ...
            <tbody>
              <?php
                $reponse = $db -> query('SELECT ordinateur.id AS id, UPPER(ordinateur.code) as code, UPPER(ordinateur.marque) as marque FROM ordinateur WHERE category_id = 1 AND user_id IS NULL AND observation = "magasin"');
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="use.php" class="btn-get-started scrollto">Ordinateur Portable</a>
