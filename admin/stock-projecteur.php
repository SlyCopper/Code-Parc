...
<body>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="affectation.php">
              <i class="bi bi-circle"></i><span>Affecation</span>
            </a>
          </li>
          <li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Projecteur en Stock</strong></h4>
      ...
      <div class="col-lg-8" style="margin: 0px auto!important;width: 100%!important;">
        <div class="row">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
                $reponse = $db -> query('SELECT COUNT(ordinateur.id) AS nombre FROM ordinateur WHERE ordinateur.category_id = 4 AND user_id IS NULL AND observation IN ("magasin", "defectueux")');
                $countSql = $reponse -> fetch();
                $reponse = $db -> query('SELECT ordinateur.id AS id,UPPER(ordinateur.marque) AS marque, UPPER(ordinateur.code) AS code,DATE_FORMAT(ordinateur.date_affectation,"%d/%m/%Y %H:%i:%s") AS date_affectation, UPPER(observation) AS observation FROM ordinateur WHERE ordinateur.category_id = 4 AND observation IN ("magasin","defectueux")');
