...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-laptop"></i><span>Ordinateur Laptop</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Autre</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="imprimante.php">
              <i class="bi bi-circle"></i><span>Imprimante</span>
            </a>
          </li>
          <li>
            <a href="projecteur.php">
              <i class="bi bi-circle"></i><span>Projecteur</span>
            </a>
          </li>
          <li>
            <a href="gamer.php">
              <i class="bi bi-circle"></i><span>Ordinateur Gamer</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Ordinateur en Utilisation</strong></h4>
    ...
    <section class="section dashboard">
      <div class="col-lg-8" style="margin: 0px auto!important;width: 100%!important;">
        <div class="row">
          <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModalDesktop" style="margin-left: 900px; width: 130px!important;background-color: rgb(9,1,143)!important; margin-bottom: 20px" ><strong><i class="bi bi-plus"></i>Ajouter</strong></button>
          <div class="modal" id="myModalDesktop">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Ajouter un ordinateur en cours d'utilisation</h4>
                  <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                  <!-- Modal Header -->
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                  <form class="form-inline" action="insert_computer_user.php" method ="post">
                    <div class="form-group">
                      ...
                      <select class="form-select" id="collaborateur" name="collaborateur">
                        <?php
                          $reponse = $db -> query('SELECT id, UPPER(nom) AS nom FROM user ORDER BY nom ASC');
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-select" id="categorie" name = "categorie">
                        <option value="1">Ordinateur Desktop</option>
                      </select>
                    </div>
                    <br>
                    <div>
              ...
              <?php
                ...
                while($data = $reponse -> fetch()){
                  ...
                  echo '<td style="width:350px;;"><a type="button" class= "btn btn-outline-dark" href="update.php?id='.$data['id'].'"><i class="bi bi-pencil-square"></i></a>
                    <a type="button" onclick="return confirm_delete()" class= "btn btn-outline-dark" href="delete.php?id='.$data['id'].'"><i class="bi bi-trash-fill style="font-size: 20px!important""></i></a>
                    </td>';
                  echo '</tr>';
                }
                Database::deconnect();
