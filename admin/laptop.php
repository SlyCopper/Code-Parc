    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-pc-display-horizontal"></i><span>Ordinateur Desktop</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
                  ...
                  <form class="form-inline" action="insert_computer_user.php" method ="post">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-select" id="categorie" name = "categorie">
                        <option value="2">Ordinateur Laptop</option>
                      </select>
                    </div>
                    <br>
                    <div>
