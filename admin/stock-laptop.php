...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-pc-display-horizontal"></i><span>Ordinateur Destktop</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Ordinateur en Stock</strong></h4>
      ...
      <div class="col-lg-8" style="margin: 0px auto!important;width: 100%!important;">
        <div class="row">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Ajouter un ordinateur en Stock</h4>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
                $reponse = $db -> query('SELECT COUNT(ordinateur.id) AS nombre FROM ordinateur WHERE ordinateur.category_id = 2 AND user_id IS NULL');
                $countSql = $reponse -> fetch();
                $reponse = $db -> query('SELECT id , UPPER(code) as code, UPPER(marque) as marque,CONCAT(dernier_utilisateur, " ", DATE_FORMAT(ordinateur.date_affectation,"%d/%m/%Y %H:%i:%s")) AS date_affectation, UPPER(observation) as observation FROM ordinateur WHERE category_id = 2 AND user_id IS NULL');
