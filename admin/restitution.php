...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Liste de restitution d'oridnateur</strong></h4>
        ...
        <div class="row">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                        $db = Database::connect();
                        $sqlQuery = $db -> query('SELECT ordinateur.id AS id, user.nom AS nom, ordinateur.date_affectation AS date_affectation, ordinateur.marque AS marque, ordinateur.code AS code FROM ordinateur JOIN user ON (ordinateur.user_id = user.id) WHERE etat = 2 AND category_id IN (1,2)');
                        while($data = $sqlQuery->fetch()){
                            ...
                            echo '<td style="width:350px;"><a class="btn btn-outline-success" href="restituer.php?ordinateur_id='.$data['id'].'"><i class="bi bi-check2"></i></a>
                            </td>';
                            echo '</tr>';
                        }
                        Database::deconnect();
