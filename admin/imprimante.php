...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Imprimante en Utilisation</strong></h4>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Ajouter une imprimante en cours d'utilisation</h4>
