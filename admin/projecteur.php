...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-printer"></i><span>Imprimante</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h4 style="color: rgb(9,1,143);"><strong>Projecteur en Utilisation</strong></h4>
      ...
      <div class="col-lg-8" style="margin: 0px auto!important;width: 100%!important;">
        <div class="row">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Ajouter un projecteur en cours d'utilisation</h4>
                  ...
                  <form class="form-inline" action="insert_computer_user.php" method ="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="observation" id="observation">
                            <option value="En Utilisation">En cour d'utilisation</option>
                        </select>
                    </div>
                    <br>
                    <div class="form-group">
                      ...
                      <select class="form-select" id="categorie" name = "categorie">
                        <option value="4">Projecteur</option>
                      </select>
                    </div>
                    <br>
                    <div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
                $reponse = $db -> query('SELECT COUNT(ordinateur.id) AS nombre FROM ordinateur WHERE ordinateur.category_id = 4 AND user_id IS NULL AND observation = "En Utilisation"');
                $countSql = $reponse -> fetch();
                $reponse = $db -> query('SELECT ordinateur.id AS id,UPPER(ordinateur.marque) AS marque, UPPER(ordinateur.code) AS code,DATE_FORMAT(ordinateur.date_affectation,"%d/%m/%Y %H:%i:%s") AS date_affectation, UPPER(observation) AS observation FROM ordinateur WHERE ordinateur.category_id = 4 AND observation ="En Utilisation"');
